...
public class UIManager : MonoBehaviour {
    ...
    public void DisplaySplit() {
        ...
        LeanTween.value(splitText.gameObject, splitText.transform.localScale.x, 1, 0.7F).
            setOnUpdate((xScale) => { splitText.transform.localScale = new Vector2(xScale, splitText.transform.localScale.y); }).
            setEase(LeanTweenType.easeOutBounce);
        LeanTween.value(splitText.gameObject, splitText.transform.localScale.y, 1, 0.7F).
